...
object Users {
    ...
    const val ME_REVIEWS_LATEST = "$USERS/me/reviews/latest"
...
object Profiles {
    ...
    private const val USERS_ME = "${Api.PREFIX}/users/me"
    const val ME = "$USERS_ME/profile"
    const val USER = "$PROFILES/user/{username}"
    const val SOCIAL_MEDIA = "$USERS_ME/social-media"
    const val PRIVACY = "$USERS_ME/privacy"
    const val NOTIFICATIONS = "$USERS_ME/notifications"
    const val ACTIVITY = "$USERS_ME/activity"
    const val ACTIVITY_PUBLIC = "$USERS_ME/activity/public"
    const val ACTIVITY_RECENT = "$USERS_ME/activity/recent"
    const val ACTIVITY_STATS = "$USERS_ME/activity/stats"
    const val USER_ACTIVITY_RECENT = "$PROFILES/user/{username}/activity/recent"
    const val ADDRESSES = "$USERS_ME/addresses"
    const val ADDRESS_ID = "$USERS_ME/addresses/{addressId}"
}
...
object Books {
    ...
    const val ALL_REVIEWS = "$BOOKS/{bookId}/reviews"
}
...
object GenrePreferences {
    const val LIST = "${Api.PREFIX}/users/me/genre-preferences"
}
