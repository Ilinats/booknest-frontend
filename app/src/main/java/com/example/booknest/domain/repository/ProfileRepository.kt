...
interface ProfileRepository {
    ...
    suspend fun updateUserProfile(userId: String, profile: UpdateUserProfileRequest): Result<UserResponse>
    ...
    suspend fun getMyActivity(limit: Int? = 20): Result<List<UserActivityResponse>>
    suspend fun getMyPublicActivity(limit: Int? = 20): Result<List<UserActivityResponse>>
    suspend fun getMyRecentActivity(days: Int? = 7, limit: Int? = 50): Result<List<UserActivityResponse>>
    suspend fun getUserRecentActivity(username: String, days: Int? = 7, limit: Int? = 50): Result<List<UserActivityResponse>>
    ...
    suspend fun updateAddress(addressId: String, address: UpdateAddressRequest): Result<ReaderAddressResponse>
